...
<div id="content" class="container-fluid p-0" style="font-family: 'Newsreader', serif;">
    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-2">
            <div class="card-header py-3" style="background-color: #426B1F; color: white;">
                <div class="row">
                    <div class="col-md-8">
                        <h6 class="m-0 font-weight-bold" id="title">ATUALIZAR DADOS DO USUÁRIO</h6>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <form class="user" action="editar_usuario_envia.php" method="post">
                    ...
                    <div class="card-footer text-muted" id="btn-form">
                        <div class="text-right">
                            <a title="Voltar" href="usuario.php"><button type="button" class="btn btn-success" style="background-color: #426B1F; border-color: #426B1F;"><i class="fas fa-arrow-circle-left"></i>&nbsp;</i>Voltar</button></a>
                            <a title="Adicionar"><button type="submit" name="updatebtn" class="btn btn-primary" style="background-color: #426B1F; border-color: #426B1F;"><i class="fas fa-edit">&nbsp;</i>Atualizar</button> </a>
                        </div>
                    </div>
                </form>  
            </div>
